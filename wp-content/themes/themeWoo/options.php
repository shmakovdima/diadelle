...
// ---------------------------------------------------------
			...
			$background_defaults = array(
				'color' => '#F1EEE8', 
				'image' => get_stylesheet_directory_uri() . "/images/main-bg.jpg", 
				'repeat' => 'repeat',
				'position' => 'top center',
				'attachment'=>'scroll'
			);
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#787878'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '28px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#181818'));
			
			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '24px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#181818'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '17px', 'lineheight' => '20px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#181818'));
			
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '16px', 'lineheight' => '20px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#181818'));
								
			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#181818'));
								
			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#181818'));
...
//shop			
		...
		$options['home_banner'] = array(
					"desc" => __( "Home page banner:", $tm_theme_texdomain ),
					"id" => "home_banner",
					"type" => "info");

		$options['home_banner_img'] = array("name" => __( "Banner Image", $tm_theme_texdomain ),
				"desc" => __( "Upload your home page banner image", $tm_theme_texdomain ),
				"id" => "home_banner_img",
				"type" => "upload",
				"std" => get_stylesheet_directory_uri() . "/images/home_banner.jpg");

		$options['home_banner_url'] = array( "name" => __( "Banner URL", $tm_theme_texdomain ),
					"desc" => __( "Please input your Banner URL (may be empty)", $tm_theme_texdomain ),
					"id" => "home_banner_url",
					"std" => get_bloginfo( 'url' ) . "/shop/",
					"class" => "tiny",
					"type" => "text");

		$options[] = array( "name" => __( "Empty cart message", $tm_theme_texdomain ),
					"desc" => __( "Empty cart message (for drop-down cart in header)", $tm_theme_texdomain ),
					"id" => "empty_cart_mess",
		...
		$options['prod_per_page'] = array( "name" => __( "Products per page", $tm_theme_texdomain ),
					"desc" => __( "Number of producrs per catalog page", $tm_theme_texdomain ),
					"id" => "prod_per_page",
					"std" => "8",
					"type" => "select",
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '60px', 'lineheight' => '64px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#191919'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '17px', 'lineheight' => '53px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#181818'));
